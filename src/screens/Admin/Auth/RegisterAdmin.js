...
class RegisterAdmin extends Component {
    ...
    render() {
        const { secure, csecure, nama, email, alamat, telepon, password, cpassword, validatePass, messagePass } = this.state;
        return (
                        ...
                        <View style={{ ...styles.row, justifyContent: 'space-between', marginTop: -5 }}>
                            <View style={{ flexDirection: 'row', alignItems: 'center', }}>
                                ...
                                <TextInput
                                    placeholder="Alamat"
                                    style={{
                                        height: 40, width: width / 1.4, marginLeft: 10, ...textStyles.mediumText
                                    }}
                                    autoCapitalize='none'
                                    keyboardType='default'
                                    clearButtonMode='while-editing'
